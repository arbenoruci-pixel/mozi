...
import { dbGetOpenDay, dbAddMove } from '@/lib/arkaDb';
...
export async function recordCashMove({
  ...
  // DB write (preferred)
  try {
    // NOTE: dbCanWork() was removed from the project.
    // If DB/RLS is misconfigured, dbGetOpenDay/dbAddMove will throw
    // and we'll gracefully fall back to offline queue.
